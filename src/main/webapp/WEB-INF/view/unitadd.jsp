            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form method="post" id="updateform" action="/unit/save" class="form-horizontal">
                            <div class="form-group">
                            <%--<P style="position: relative;">--%>
                                <%--<span class="p_logo"></span>--%>
                                <div class="col-lg-5">
                                <input class="form-control" id="name" type="text" name="name" placeholder="请输入单位名"/>
                                </div>
                            <%--</P>--%>
                            </div>
                    ...
                    <a style="background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;" href="javascript:;" onclick="submitForm()">新增单位</a>
                </span>
                            </div>
                        </form>
                        <!-- /.table-responsive -->
